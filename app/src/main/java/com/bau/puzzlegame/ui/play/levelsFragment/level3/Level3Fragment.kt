package com.bau.puzzlegame.ui.play.levelsFragment.level3
...
class Level3Fragment : Fragment() {
    ...
    companion object {
        fun newInstance(currentActivity: changeFragmentInterface): Level3Fragment {
            val newinsta = Level3Fragment()
    ...
    override fun onCreateView(
        ...
        root = inflater.inflate(R.layout.fragment_level3, container, false)
        initFragment()
    ...
    fun initFragment() {
        ...
        recyclerView = root.findViewById(R.id.level3_recyclerView)
        timerTv = root.findViewById(R.id.level3_timer)
    ...
    fun compareToItem(firstId: String, secondId: String): Boolean {
        if (firstId == secondId)
            score += 120//increase score for each correct comparision
