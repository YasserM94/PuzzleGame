package com.bau.puzzlegame.ui.play.levelsFragment.level2
...
class Level2Fragment : Fragment() {
    ...
    companion object {
        fun newInstance(currentActivity: changeFragmentInterface): Level2Fragment {
            val newinsta = Level2Fragment()
    ...
    override fun onCreateView(
        ...
        root = inflater.inflate(R.layout.fragment_level2, container, false)
        initFragment()
    ...
    fun initFragment() {
        ...
        recyclerView = root.findViewById(R.id.level2_recyclerView)
        timerTv = root.findViewById(R.id.level2_timer)
    ...
    fun compareToItem(firstId: String, secondId: String): Boolean {
        if (firstId == secondId)
            score += 80 //increase score for each correct comparision
